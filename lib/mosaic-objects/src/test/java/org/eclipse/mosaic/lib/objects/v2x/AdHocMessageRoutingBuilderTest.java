...
public class AdHocMessageRoutingBuilderTest {
    ...
    public void testAllTTLValues() {
        for (int i = 0; i <= MAXIMUM_TTL; ++i) {
            MessageRouting routing = builder.viaChannel(adHocChannel).destination(ipAddress).topological(i);
    ...
    public void testLowerTTL() {
        builder.viaChannel(adHocChannel).destination(ipAddress).topological(-1);
    }
    ...
    public void testHigherTTL() {
        builder.viaChannel(adHocChannel).destination(ipAddress).topological(256);
    }
    ...
    public void geoBroadcastCircleAdHocChannel() {
        // run
        MessageRouting routing = builder.viaChannel(adHocChannel).broadcast().geographical(geoCircle);
    ...
    public void geoBroadcastrectangleAdHocChannel() {
        // run
        MessageRouting routing = builder.viaChannel(adHocChannel).broadcast().geographical(geoRectangle);
    ...
    public void geocast() {
        // run
        MessageRouting routing = builder.viaChannel(adHocChannel).destination(destinationAddress).geographical(geoCircle);
    ...
    public void topoBroadcastAdHocChannel() {
        // run
        MessageRouting routing = builder.viaChannel(adHocChannel).broadcast().topological();
    ...
    public void topoBroadcastAdHocChannelHops() {
        // run
        MessageRouting routing = builder.viaChannel(adHocChannel).broadcast().topological(hops);
