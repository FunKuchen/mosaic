 ...
 */
public class BicycleTurnCostAnalyzer {
    ...
    /**
     * Crates a new {@link BicycleTurnCostAnalyzer} with default calculation properties.
     */
    public BicycleTurnCostAnalyzer(BaseGraph graph, WayTypeEncoder waytypeEncoder) {
        this.graph = graph;
        this.waytypeEncoder = waytypeEncoder;
        /*
         * Mean acceleration and deceleration for bicycles in SimRa data
         * (according to [Karakaya et al: "Achieving realistic cyclist behavior in SUMO using the SimRa dataset", 2023]).
         */
        acceleration = 0.875;
        deceleration = 0.9;
        minCurveRadius = 2;
