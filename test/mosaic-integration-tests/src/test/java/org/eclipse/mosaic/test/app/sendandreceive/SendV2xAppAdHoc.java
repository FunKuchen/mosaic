    ...
    protected void sendMessage() {
        ...
        switch (sendMode) {
            case geobroad:
                ...
                routing = getOs().getAdHocModule().createMessageRouting().viaChannel(AdHocChannel.CCH).broadcast().geographical(dest);
                break;
            case geouni:
            ...
            case topo:
                ...
                routing = getOs().getAdHocModule().createMessageRouting().viaChannel(AdHocChannel.CCH).broadcast().topological();
                break;
            default:
